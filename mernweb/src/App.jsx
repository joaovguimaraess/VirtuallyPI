  ...
  return (
    <>
      ...
      <Switch>
          ...
          <Protectedroute exact path="/teste" component={Teste} auth={auth} />
          ...
          <Protectedroute exact path="/discover" component={Discover} auth={auth} />
          <Protectedroute exact path="/video" component={Video} auth={auth} />
